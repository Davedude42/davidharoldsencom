...
<ProgramInfo>
	<h2><span class="bg-blue-200">Light Blue</span></h2>
...
<div class:hidden={!pgnPopupOpen} class="fixed z-40 inset-0 flex flex-col items-center justify-center bg-black/40">
	<div style="width: 500px; height: 400px; max-width: 90%;" class="thick-black-border flex flex-col gap-4 p-4 bg-blue-200">
